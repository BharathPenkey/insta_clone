...
function Form() {
    ...
    const handlesubmit = async (e) => {
        ...
        data.append("upload_preset", "bharath");
        data.append("cloud_name", "drfg4tq7u");
        await fetch("https://api.cloudinary.com/v1_1/drfg4tq7u/image/upload", {
            //https://api.cloudinary.com/v1_1/drfg4tq7u   -->api base url
            method: "post",
            body: data
        })
            .then(res => res.json())
            .then(data => {
                ...
                axios.post('https://insta-clone-b2.onrender.com/posts', newpost)//
        ...
        <>
            <div className="main-header">
                ...
                <span className="tag">Instaclone</span>
                  {/* <div id='addPost' onClick={()=>navigate("/form")}>ADD</div> */}
                <Link to={"/form"}><img src={camera_icon} alt="icon" className="cam_logo"></img></Link>
            </div>
            <form>
                <section>
                    <div className='containerBox1' onClick={()=>navigate("/post")}><span>&#10060;</span></div>
